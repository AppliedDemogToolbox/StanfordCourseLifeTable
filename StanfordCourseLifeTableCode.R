...
##
##NOTE: I REPRODUCED THE CODE HERE TO PROVIDE AN IMMEDIATE LINK TO INPUT DATA FOR QUICK REVIEW BY POTENTIAL USERS, 
##        AND HAVE MADE A COUPLE OF SMALL MODIFICATIONS TO THE ORIGINAL OVER THE YEARS (EACH COMMENTED), BUT I DID NOT AUTHOR THIS CODE
##
...
##        https://github.com/AppliedDemogToolbox/StanfordCourseLifeTable/blob/master/StanfordCourseLifeTableCode.ipynb
##
